...
<?php
 ...
 ?>
	...
	<a href="<?php echo site_url('admin/tours'); ?>" class="btn btn-warning" style="margin-top:1%;margin-bottom:1%; ">Back</a>
		...
		<form action="<?php echo site_url('admin/tours/edit'); ?>/<?php echo base64_encode($tour['id']); ?>"  method="post" id="form_validate">
			<label>Tours / Edit Tour</label>

			<div class="form-group">
				<label for="title">Title</label>
				<input type="text" name="title" value="<?php echo $tour['title']; ?>" class="input-group" id="title" autocomplete="off"
			...
			<div class="form-group">
				...
				<input type="text" name="ratings" id="ratings"  value="<?php echo $tour['ratings']; ?>" class="input-group" autocomplete="off"
				placeholder="Enter Ratings Here.">
			
			</div>
   			<div class="form-group">
				<label for="price">Price</label>
				<input type="text" name="price" id="price" value="<?php echo $tour['price']; ?>" class="input-group" autocomplete="off"
					placeholder="Enter Price Here">
					<select name="rates_per">
						
						<option value="per_day" <?php if($tour['rates_per']=='per_day'){echo "selected";} ?> >Per Day</option>
						<option value="per_km"  <?php if($tour['rates_per']=='per_km'){echo "selected";} ?>>Per KM </option>
			...
			<div class="form-group">
				...
				<input type="text" name="pickup_loc" id="pickup_loc"  value="<?php echo $tour['pickup_loc']; ?>" class="input-group" placeholder="Search" autocomplete="off">
			</div>
      		
      		<div class="form-group">
				<label for="drop_loc">Drop Location</label><br>
				<input type="text" name="drop_loc" id="drop_loc" value="<?php echo $tour['drop_loc']; ?>" class="input-group" placeholder="Search" autocomplete="off">
			</div>

			<div class="form-group">
				<label for="pickup_date">Pickup Date</label><br>
				<input type="date" name="pickup_date" id="pickup_date" class="input-group" value="<?php echo $tour['pickup_date']; ?>" placeholder="Search" autocomplete="off">
			</div>

			<div class="form-group">
				<label for="drop_date">Drop Date</label><br>
				<input type="date" name="drop_date" id="drop_date" class="input-group" value="<?php echo $tour['drop_date']; ?>" placeholder="Search" autocomplete="off">
			</div>

			<div class="form-group">
				<label for="pickup_time">Pickup Time</label><br>
				<input type="time" name="pickup_time" id="pickup_time" class="input-group" value="<?php echo $tour['pickup_time']; ?>" placeholder="Search" autocomplete="off">
			</div>

			<div class="form-group">
				<label for="drop_time">Drop Time</label><br>
				<input type="time" name="drop_time" id="drop_time" class="input-group" placeholder="Search"  value="<?php echo $tour['drop_time']; ?>"autocomplete="off">
			</div>
...
$(document).ready(function()
{
    ...
    $("#form_validate").validate({
        ...
        messages:
        {
	           title      	 :
	           {
	           		required:"<i class='fa fa-window-close'></i> Please Enter Title of Tour."
